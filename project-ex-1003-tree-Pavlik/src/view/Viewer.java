...
import view.provider.MethodLabelPosProvider;
...
public class Viewer {
   public static final String ID = "project-ex-1003-tree-Pavlik.partdescriptor.simpleasttreeview";
   ...
   private void createProgElemColumns() {
      ...
      col.setLabelProvider(new DelegatingStyledCellLabelProvider(new MethodLabelPosProvider()));
   }
